    ...
    <div className="min-h-screen py-16 px-5">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-sm leading-relaxed">
          <section>
            <h2 className="text-xl font-semibold mb-2 text-[hsl(var(--secondary))]">1. Agreement to Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-2 text-[hsl(var(--secondary))]">2. Services Description</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-2 text-[hsl(var(--secondary))]">3. Eligibility</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-2 text-[hsl(var(--secondary))]">4. User Obligations</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-2 text-[hsl(var(--secondary))]">5. Fees, Payments, and Refunds</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-2 text-[hsl(var(--secondary))]">6. Intellectual Property Rights</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-2 text-[hsl(var(--secondary))]">7. Disclaimers</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-2 text-[hsl(var(--secondary))]">8. Limitation of Liability</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-2 text-[hsl(var(--secondary))]">9. Termination</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-2 text-[hsl(var(--secondary))]">10. Governing Law and Jurisdiction</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-2 text-[hsl(var(--secondary))]">11. Amendments</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-2 text-[hsl(var(--secondary))]">12. Contact</h2>
            <p>
              Nova Exams<br />
              Email: astronomer291@gmail.com<br />
              Phone: 0949700013
            </p>
          </section>
        </div>
